...
## Modules
- [`modules/app.md`](modules/app.md) — application entry point, builds the app's `web-ui-kit` root frame (toolbar + the stage file input as main content), wires a successful load to the characteristics panel, and mounts it into the DOM
...
- [`modules/viewer.md`](modules/viewer.md) — the screens that show what was loaded; currently the characteristics panel, displaying the loaded stage's name, author, camera bounds, and stage boundaries
