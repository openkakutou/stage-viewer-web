...
**Exports:** `loadStage(defBytes: Uint8Array, options?: WasmBridgeOptions): Promise<StageResult>`, `resetWasmBridgeForTests(): void`, `WasmBridgeOptions`, `StageData` (now including `name`/`author`), `StageResult`, `BGElement`, `BGElementType`, `SpriteRef`, `BGdef`, `CameraBounds`, `StageBoundaries`, `Model`, `Scaling`, `PlayerStartZ`
